...
int optimal_search_tree(int n, int my_rank, int cell_size_per_process, int size, vector<vector<int>> &root, bool status, int *key_arr, int *freq_arr, bool debug)
{
    int cost[n][n];
...
void run_helper(int n, int size, int my_rank)
{
    ...
    int val = optimal_search_tree(n, my_rank, cell_size_per_process, size, root, true, sorted_key_arr, sorted_freq_arr, false);
